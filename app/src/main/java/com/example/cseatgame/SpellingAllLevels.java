...
public class SpellingAllLevels extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spelling_all_levels);
    ...
    private void openLvl1Activity() {
        Intent main = new Intent(this,SpellingLvl1.class);
        startActivity(main);
    }
}